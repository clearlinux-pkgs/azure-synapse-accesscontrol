...
%package python
Summary: python components for the azure-synapse-accesscontrol package.
Group: Default
Requires: azure-synapse-accesscontrol-python3 = %{version}-%{release}

%description python
python components for the azure-synapse-accesscontrol package.


%package python3
Summary: python3 components for the azure-synapse-accesscontrol package.
Group: Default
Requires: python3-core
Provides: pypi(azure_synapse_accesscontrol)
Requires: pypi(azure_common)
Requires: pypi(azure_core)
Requires: pypi(msrest)

%description python3
python3 components for the azure-synapse-accesscontrol package.


%prep
%setup -q -n azure-synapse-accesscontrol-0.4.0
cd %{_builddir}/azure-synapse-accesscontrol-0.4.0
